...
# Study 2 CONTROLS - LEFT HEMISPHERIC FRONTO-BASAL-GANGLIA FBA TRAJECTORIES

dir.create("./FBA_gams_Controls_only/LH")

# MODELS WITH COVARS (FULL MODEL)

# GAM models for EXG3 parameters
dir.create("./FBA_gams_Controls_only/LH/fullmodel")

models<-lapply(X=as.character(as.list(lh_dvs_CON)),
               df=lh_xlong_CON,
               FUN=function(dv_name, df) {
                 print(dv_name)
                 
                 # now create a new dataframe within the loop that is filtered to dv_name
                 adf<-df %>% filter(lh_dvs_CON==dv_name) %>%
                 ...
                 save(gam1a,gam2a,gam3a,gam4a, file = paste0("./FBA_gams_Controls_only/LH/fullmodel/", dv_name,"_gams_models.Rdata"))
                 ...
                 if (pvalue1 < 0.05) {
                   ...
                   ggsave(filename=paste0("./FBA_gams_Controls_only/LH/fullmodel/", dv_name, '.png'), plot=best_plot,width=6,height=5)
                   
                   tiff(paste0("./FBA_gams_Controls_only/LH/fullmodel/", dv_name, "_check.tiff"), width = 9, height = 6, units = 'in', res = 150)
                   par(mfrow=c(2,2))
...
write.csv(LH_FBA_models_EXG3,file= "./FBA_gams_Controls_only/LH/fullmodel/lh_fba_models.csv",row.names=F)
...
write_csv(LH_modelsFDR,path = "./FBA_gams_Controls_only/LH/fullmodel/lh_fba_models_FDR.csv")
...
# GAM models for EXG3 parameters
dir.create("./FBA_gams_Controls_only/LH/noSES")

models_noSES<-lapply(X=as.character(as.list(lh_dvs_CON)),
               df=lh_xlong_CON,
               FUN=function(dv_name, df) {
                 print(dv_name)
                 ...
                 save(gam1a,gam2a,gam3a,gam4a, file = paste0("./FBA_gams_Controls_only/LH/noSES/", dv_name,"_gams_models_noSES.Rdata"))
                 ...
                 if (pvalue1 < 0.05) {
                   ...
                   ggsave(filename=paste0("./FBA_gams_Controls_only/LH/noSES/", dv_name, '_noSES.png'), plot=best_plot,width=6,height=5)

                   tiff(paste0("./FBA_gams_Controls_only/LH/noSES/", dv_name, "_check_noSES.tiff"), width = 9, height = 6, units = 'in', res = 150)
                   par(mfrow=c(2,2))
                   gam.check(best_model)
                   dev.off()
...
LH_FBA_models_EXG3_noSES <- rbindlist(models_noSES,fill=TRUE)
View(LH_FBA_models_EXG3_noSES)
write.csv(LH_FBA_models_EXG3_noSES,file= "./FBA_gams_Controls_only/LH/noSES/lh_fba_models_noSES.csv",row.names=F)


LH_modelsFDR_noSES <- LH_FBA_models_EXG3_noSES[,c(1,6,7,10,14,18,19)]
LH_modelsFDR_noSES$p.fdr <- p.adjust(LH_modelsFDR_noSES$`Pr(>|t|)`,method="fdr")
LH_modelsFDR_noSES$pvalue.fdr <- p.adjust(LH_modelsFDR_noSES$`p.value`,method="fdr")
LH_modelsFDR_noSES$`p-value.fdr` <- p.adjust(LH_modelsFDR_noSES$`p-value`,method="fdr")
write_csv(LH_modelsFDR_noSES,path = "./FBA_gams_Controls_only/LH/noSES/lh_fba_models_FDR_noSES.csv")
...
# GAM models for EXG3 parameters
dir.create("./FBA_gams_Controls_only/LH/noFWD")

models_noFWD<-lapply(X=as.character(as.list(lh_dvs_CON)),
               df=lh_xlong_CON,
               FUN=function(dv_name, df) {
                 print(dv_name)
                 ...
                 save(gam1a,gam2a,gam3a,gam4a, file = paste0("./FBA_gams_Controls_only/LH/noFWD/", dv_name,"_gams_models_noFWD.Rdata"))
                 ...
                 if (pvalue1 < 0.05) {
                   ...
                   ggsave(filename=paste0("./FBA_gams_Controls_only/LH/noFWD/", dv_name, '_noFWD.png'), plot=best_plot,width=6,height=5)

                   tiff(paste0("./FBA_gams_Controls_only/LH/noFWD/", dv_name, "_check_noFWD.tiff"), width = 9, height = 6, units = 'in', res = 150)
                   par(mfrow=c(2,2))
                   gam.check(best_model)
                   dev.off()
...
LH_FBA_models_EXG3_noFWD <- rbindlist(models_noFWD,fill=TRUE)
View(LH_FBA_models_EXG3_noFWD)
write.csv(LH_FBA_models_EXG3_noFWD,file= "./FBA_gams_Controls_only/LH/noFWD/lh_fba_models_noFWD.csv",row.names=F)


LH_modelsFDR_noFWD <- LH_FBA_models_EXG3_noFWD[,c(1,6,7,10,14,18,19)]
LH_modelsFDR_noFWD$p.fdr <- p.adjust(LH_modelsFDR_noFWD$`Pr(>|t|)`,method="fdr")
LH_modelsFDR_noFWD$pvalue.fdr <- p.adjust(LH_modelsFDR_noFWD$`p.value`,method="fdr")
LH_modelsFDR_noFWD$`p-value.fdr` <- p.adjust(LH_modelsFDR_noFWD$`p-value`,method="fdr")
write_csv(LH_modelsFDR_noFWD,path = "./FBA_gams_Controls_only/LH/noFWD/lh_fba_models_FDR_noFWD.csv")
...
# GAM models for EXG3 parameters
dir.create("./FBA_gams_Controls_only/LH/noICV")

models_noICV<-lapply(X=as.character(as.list(lh_dvs_CON)),
               df=lh_xlong_CON,
               FUN=function(dv_name, df) {
                 print(dv_name)
                 ...
                 save(gam1a,gam2a,gam3a,gam4a, file = paste0("./FBA_gams_Controls_only/LH/noICV/", dv_name,"_gams_models_noICV.Rdata"))
                 ...
                 if (pvalue1 < 0.05) {
                   ...
                   ggsave(filename=paste0("./FBA_gams_Controls_only/LH/noICV/", dv_name, '_noICV.png'), plot=best_plot,width=6,height=5)

                   tiff(paste0("./FBA_gams_Controls_only/LH/noICV/", dv_name, "_check_noICV.tiff"), width = 9, height = 6, units = 'in', res = 150)
                   par(mfrow=c(2,2))
                   gam.check(best_model)
                   dev.off()
...
LH_FBA_models_EXG3_noICV <- rbindlist(models_noICV,fill=TRUE)
View(LH_FBA_models_EXG3_noICV)
write.csv(LH_FBA_models_EXG3_noICV,file= "./FBA_gams_Controls_only/LH/noICV/lh_fba_models_noICV.csv",row.names=F)


LH_modelsFDR_noICV <- LH_FBA_models_EXG3_noICV[,c(1,6,7,10,14,18,19)]
LH_modelsFDR_noICV$p.fdr <- p.adjust(LH_modelsFDR_noICV$`Pr(>|t|)`,method="fdr")
LH_modelsFDR_noICV$pvalue.fdr <- p.adjust(LH_modelsFDR_noICV$`p.value`,method="fdr")
LH_modelsFDR_noICV$`p-value.fdr` <- p.adjust(LH_modelsFDR_noICV$`p-value`,method="fdr")
write_csv(LH_modelsFDR_noICV,path = "./FBA_gams_Controls_only/LH/noICV/lh_fba_models_FDR_noICV.csv")
