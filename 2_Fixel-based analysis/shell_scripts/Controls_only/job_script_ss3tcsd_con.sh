...
ss3t_csd_beta1 $data_dir/$subid/$sessid/dwi_denoised_unringed_preproc_unbiased_upsampled.mif $work_dir/control_group_average_response_wm.txt $work_dir/subjects_controls/${subid}_${sessid}/wmfod.mif $work_dir/control_group_average_response_gm.txt $work_dir/subjects_controls/${subid}_${sessid}/gm.mif $work_dir/control_group_average_response_csf.txt $work_dir/subjects_controls/${subid}_${sessid}/csf.mif -mask $data_dir/$subid/$sessid/mask_unbiased_combined_upsampled.mif

cd $work_dir/subjects_controls
